          ...
          >
            ...
            <section>
              <button
                ...
                type="submit"
                disabled={!isValidJsonString(currentQuestionEditJson)}
              >
                Submit
              </button>
            </section>
            ...
            >
              ...
              <section>
                <button
                  ...
                  type="submit"
                  disabled={
                    !isValidJsonString(currentQuestionAddJson) ||
                    (isValidJsonString(currentQuestionAddJson) &&
                      hasEmptyValues(JSON.parse(currentQuestionAddJson)))
                  }
                >
                  Submit
                </button>

describe("The Use of the Editor", () => {
    it("allows a user to use the code editor in the collaboration space", () => {
        ...
        cy.get("div[class='monaco-editor no-user-select mac  showUnused showDeprecated vs']").should("be.visible");
        cy.get("label[class='chakra-switch css-1gmw4cr']").should("be.visible").click();
        cy.get("div[class='monaco-editor no-user-select mac  showUnused showDeprecated vs-dark']").should("be.visible");
        cy.get("label[class='chakra-switch css-1gmw4cr']").should("be.visible").click();
        cy.get("div[class='monaco-editor no-user-select mac  showUnused showDeprecated vs']").should("be.visible");
